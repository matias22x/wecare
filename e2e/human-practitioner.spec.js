describe("Human Practitioner", function() {
    ...
    var humanpractitionerMock = require("./mocks/practitioner-mock.js");

    before(function() {
        browser.clearMockModules();
        browser.addMockModule('practitionerBackendMock', humanpractitionerMock.practitionerBackendMock);
        var width = 1920;
        var height = 1080;
    ...
    it("should create an Human practitioner", function(done) {
        ...
        expect(element(by.binding('user_data.type')).getText()).to.eventually.equal('Practitioner');
        done();
    });
});
