describe("Human Coordinator ", function() {
    ...
    var coordinatorMock = require("./mocks/coordinator-mock.js");

    before(function() {
        browser.clearMockModules();
        browser.addMockModule('coordinatorBackendMock', coordinatorMock.coordinatorBackendMock);
        var width = 1920;
        var height = 1080;
    ...
    it("should create an coordinator", function(done) {
        ...
        var username = element(by.model('user_data.username'));
        username.click();
        ...
        expect(element(by.binding('user_data.type')).getText()).to.eventually.equal('Coordinator');
        done();
    });
});
