describe("Encounter ", function() {
  ...
  var encounterMock = require("./mocks/encounter-mock.js");

  before(function() {
    browser.clearMockModules();
    browser.addMockModule('encounterBackendMock', encounterMock.encounterBackendMock);
    var width = 1920;
    var height = 1080;
  ...
  it("should create an encounter", function(done) {
    ...
    browser.executeScript('document.getElementById("slide-out").scrollTop = 2000').then(function() {
      element(by.css('[ui-sref="encounter"]')).click();
    });
    browser.wait(EC.visibilityOf( element(by.css('[ui-sref="encounter.edit"]'))), 10000);
    element(by.css('[ui-sref="encounter.edit"]')).click();
    ...
    element.all(by.repeater('encounter in encounter_list')).last().element(by.css("[ui-sref='encounter.edit({encounter_id:encounter._id})']")).click();
