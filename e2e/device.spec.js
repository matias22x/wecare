describe("Device ", function() {
    ...
    var deviceMock = require("./mocks/device-mock.js");

    before(function() {
        browser.clearMockModules();
        browser.addMockModule('deviceBackendMock', deviceMock.deviceBackendMock);
        var width = 1920;
        var height = 1080;
    ...
    it("should create an device", function(done) {
        ...
        browser.executeScript('document.getElementById("slide-out").scrollTop = 2000').then(function() {
            element(by.css('[ui-sref="device"]')).click();
        });
        browser.wait(EC.visibilityOf(element(by.css('[ui-sref="device.edit"]'))), 10000);
        element(by.css('[ui-sref="device.edit"]')).click();
        ...
        element.all(by.repeater('device in device_list')).last().element(by.css("[ui-sref='device.edit({device_id: device._id})']")).click();
