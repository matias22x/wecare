describe("Human Organization Administrator", function() {
    ...
    var humanorganizationAdministratorMock = require("./mocks/organization-administrator-mock.js");

    before(function() {
        browser.clearMockModules();
        browser.addMockModule('organizationadministratorBackendMock', humanorganizationAdministratorMock.organizationadministratorBackendMock);
        var width = 1920;
        var height = 1080;
    ...
    it("should create an Human organization Administrator", function(done) {
        ...
        expect(element(by.binding('user_data.type')).getText()).to.eventually.equal('Organization Administrator');
        done();
